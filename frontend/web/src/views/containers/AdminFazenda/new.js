      ...
      },
      {
        ...
        render: (text, record) => (
          <Box>
            ...
            <Table pagination={false} columns={talhoesColumns} dataSource={record.talhoes} />
          </Box>
        ),
      },
    ];
                  ...
                  <Box title="Seções">
                    ...
                    <Button
                      onClick={() => {
                        ...
                        setFieldsValue({
                          secoes: getFieldValue('secoes').concat({
                            numero: this.state.numeroSecao,
                            talhoes: [],
                          }),
                        });
                        this.onChangeSecao('');
