        ...
        <PageHeader>Empresa &nbsp;&nbsp; {this.props.loading ? <Spin/> : ''}</PageHeader>
          ...
          <ContentHolder>
            <form onSubmit={handleSubmit(this.props.save)}>
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <Button type="secondary" disabled={pristine || submitting || this.props.loading} onClick={reset}>
                Limpar
              </Button>
            </form>
          </ContentHolder>
...
export default (connect(mapStateToProps, mapDispatchToProps)(AdminEmpresaNew));