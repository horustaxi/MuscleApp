...
class AdminEmpresaEdit extends Component {
  ...
  render() {
    ...
    return (
      <LayoutContent>        
        <PageHeader>Empresa &nbsp;&nbsp; {this.props.loading ? <Spin/> : ''}</PageHeader>
          {this.renderAlert()}
          <Box title="Edição">
          <ContentHolder>
            <form onSubmit={handleSubmit(this.props.save)}>
              ...
              <Row gutter={16}>
                ...
                <Col md={6} sm={12} xs={24} style={colStyle}>
                  <br/>
                  <Field name="ativo" component={SwitchField} type="text"
                  checkedChildren={'Ativo'}
                  unCheckedChildren={'Inativo'} />
                </Col>
              </Row>
              <Button type="primary" htmlType="submit" disabled={pristine || submitting || this.props.loading}>
                Salvar Alteração
              </Button>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
export default (connect(mapStateToProps, mapDispatchToProps)(AdminEmpresaEdit));