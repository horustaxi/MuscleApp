...
class AdminFilialEdit extends Component {
  ...
  render() {
    ...
    return (
      <LayoutContent>        
        <PageHeader>Filial &nbsp;&nbsp; {this.props.loading ? <Spin/> : ''}</PageHeader>
          {this.renderAlert()}
          <Box title="Edição">
          <ContentHolder>
            <form onSubmit={handleSubmit(this.props.save)}>
              ...
              <Row gutter={16}>
                ...
                <Col md={6} sm={12} xs={24} style={colStyle}>
                  <br/>
                  <Field name="ativo" component={SwitchField}
...
export default (connect(mapStateToProps, mapDispatchToProps)(AdminFilialEdit));