...
class AdminUsuarioNew extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (prevProps.usuario) {
      if (prevProps.usuario.permissoes !== this.props.usuario.permissoes
  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        values = {
          ...values,
          permissoes: this.state.permissoesUsuario.map(item => {
            return { id: item };
          }),
        }
        ...
        <Box title="Edição">
          <ContentHolder>
            <Form onSubmit={this.handleSubmit}>
              <Row gutter={16}>
                <FormItem>
                  {getFieldDecorator('id', { initialValue: usuario.id })(
                  <Input type="hidden" />
                  )}
                </FormItem>
                ...
                <Col md={6} sm={12} xs={24} style={colStyle}>
                  ...
                  <FormItem>
                    {getFieldDecorator('isFuncionario', {
                      initialValue: usuario.funcionario && usuario.funcionario.ativo ? true : false,
                    })(
                    <Switch
                      checkedChildren={'Sim'}
                      ...
                      <Col md={12} sm={12} xs={24} style={colStyle}>
                        ...
                        <FormItem>
                          {getFieldDecorator('funcionario.filial.id', {
                            initialValue: usuario.funcionario ? usuario.funcionario.filial.id : undefined,
                            rules: [{ required: true, message: 'Preenchimento obrigatório!' }],
                          })(
                          <Select
                            showSearch
                      ...
                      <Col md={12} sm={12} xs={24} style={colStyle}>
                        ...
                        <FormItem>
                          {getFieldDecorator('funcionario.matricula', {
                            initialValue: usuario.funcionario ? usuario.funcionario.matricula : undefined,
                            rules: [
                      ...
                      <Col md={12} sm={12} xs={24} style={colStyle}>
                        ...
                        <FormItem>
                          {getFieldDecorator('funcionario.cargo.id', {
                            initialValue: usuario.funcionario ? usuario.funcionario.cargo.id : undefined,
                            rules: [{ required: true, message: 'Preenchimento obrigatório!' }],
                          })(
                          <Select
                            showSearch
