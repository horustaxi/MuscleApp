...
public class WorksetController {
	...
	@GetMapping(value = "/workout-sheet/{workoutSheetId}/workset")
	public ResponseEntity<List<WorksetDTO>> getAllByCreatedByUserOrCreatedToUser(
