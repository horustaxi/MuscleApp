...
public class DevBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private void initMuscles() {
        ...
        if (muscleRepository.count() == 0) {
            ...
            MuscleGroup muscleGroup3 = muscleGroupRepository.findMuscleGroupByName("shoulders").get();
            ...
            MuscleGroup muscleGroup6 = muscleGroupRepository.findMuscleGroupByName("buttocks").get();
    ...
    private void initExercises() {
        ...
        if (exerciseRepository.count() == 0) {
            ...
            crunch.getSecondaryMuscles().add(muscleRepository.findMuscleByName("serratus anterior").get());
            ...
            legRaise.getSecondaryMuscles().add(muscleRepository.findMuscleByName("serratus anterior").get());
            legRaise.getSecondaryMuscles().add(muscleRepository.findMuscleByName("hip flexors").get());
            ...
            squat.getSecondaryMuscles().add(muscleRepository.findMuscleByName("erector spinae").get());
            squat.getSecondaryMuscles().add(muscleRepository.findMuscleByName("infraspinatus").get());
            exercises.add(squat);
            ...
            legPress.getMainMuscles().add(muscleRepository.findMuscleByName("gluteus maximus").get());
            legPress.getSecondaryMuscles().add(muscleRepository.findMuscleByName("hamstrings").get());
            ...
            deadlift.getMainMuscles().add(muscleRepository.findMuscleByName("erector spinae").get());
            deadlift.getMainMuscles().add(muscleRepository.findMuscleByName("gluteus maximus").get());
            deadlift.getSecondaryMuscles().add(muscleRepository.findMuscleByName("hamstrings").get());
            ...
            barbellRow.getMainMuscles().add(muscleRepository.findMuscleByName("infraspinatus").get());
            barbellRow.getSecondaryMuscles().add(muscleRepository.findMuscleByName("biceps").get());
            barbellRow.getSecondaryMuscles().add(muscleRepository.findMuscleByName("forearms").get());
            ...
            standingCalfRaise.getMainMuscles().add(muscleRepository.findMuscleByName("calves").get());
            ...
            benchPress.getMainMuscles().add(muscleRepository.findMuscleByName("pectoralis major").get());
            benchPress.getMainMuscles().add(muscleRepository.findMuscleByName("triceps").get());
            benchPress.getSecondaryMuscles().add(muscleRepository.findMuscleByName("anterior delts").get());
            ...
            chestFly.getMainMuscles().add(muscleRepository.findMuscleByName("pectoralis major").get());
            chestFly.getSecondaryMuscles().add(muscleRepository.findMuscleByName("forearms").get());
            chestFly.getSecondaryMuscles().add(muscleRepository.findMuscleByName("anterior delts").get());
            ...
            pulldown.getSecondaryMuscles().add(muscleRepository.findMuscleByName("posterior delts").get());
            ...
            chinUp.getSecondaryMuscles().add(muscleRepository.findMuscleByName("posterior delts").get());
            ...
            uprightRow.getMainMuscles().add(muscleRepository.findMuscleByName("lateral delts").get());
            uprightRow.getSecondaryMuscles().add(muscleRepository.findMuscleByName("posterior delts").get());
            uprightRow.getSecondaryMuscles().add(muscleRepository.findMuscleByName("trapezius").get());
            uprightRow.getSecondaryMuscles().add(muscleRepository.findMuscleByName("forearms").get());
            ...
            shoulderPress.getMainMuscles().add(muscleRepository.findMuscleByName("anterior delts").get());
            shoulderPress.getMainMuscles().add(muscleRepository.findMuscleByName("triceps").get());
            shoulderPress.getSecondaryMuscles().add(muscleRepository.findMuscleByName("lateral delts").get());
            shoulderPress.getSecondaryMuscles().add(muscleRepository.findMuscleByName("trapezius").get());
            exercises.add(shoulderPress);

            Exercise ohp = new Exercise("over head press", "The shoulder press is performed while seated, or standing by lowering a weight held above the head to just above the shoulders, and then raising it again.", Language.ENGLISH);
            ...
            militaryPress.getMainMuscles().add(muscleRepository.findMuscleByName("anterior delts").get());
            militaryPress.getMainMuscles().add(muscleRepository.findMuscleByName("triceps").get());
            militaryPress.getSecondaryMuscles().add(muscleRepository.findMuscleByName("lateral delts").get());
            militaryPress.getSecondaryMuscles().add(muscleRepository.findMuscleByName("trapezius").get());
            militaryPress.getSecondaryMuscles().add(muscleRepository.findMuscleByName("abdominals").get());
            militaryPress.getSecondaryMuscles().add(muscleRepository.findMuscleByName("erector spinae").get());
            militaryPress.getSecondaryMuscles().add(muscleRepository.findMuscleByName("infraspinatus").get());
            ...
            lateralRaise.getMainMuscles().add(muscleRepository.findMuscleByName("lateral delts").get());
            lateralRaise.getSecondaryMuscles().add(muscleRepository.findMuscleByName("posterior delts").get());
            ...
            tricepsExtension.getMainMuscles().add(muscleRepository.findMuscleByName("triceps").get());
            ...
            preacherCurl.getSecondaryMuscles().add(muscleRepository.findMuscleByName("forearms").get());
